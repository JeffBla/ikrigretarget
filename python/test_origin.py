...
def config_gpt_meta():
    ...
    config.TargetChains.append(
        ir.SoulIKRigChain("spine", "Rol01_Torso0102Jnt_M",
                          "Rol01_Neck0101Jnt_M"))
    config.TargetChains.append(
        ir.SoulIKRigChain("head", "Rol01_Neck0102Jnt_M", "Head_M"))

    # lleg
    config.TargetChains.append(
        ir.SoulIKRigChain("lleg1", "Rol01_Leg01Up01Jnt_L",
                          "Rol01_Leg01Up01Jnt_L"))
    config.TargetChains.append(
        ir.SoulIKRigChain("lleg2", "Rol01_Leg01Low01Jnt_L",
                          "Rol01_Leg01Low01Jnt_L"))
    config.TargetChains.append(
        ir.SoulIKRigChain("lleg3", "Rol01_Leg01AnkleJnt_L",
                          "Rol01_Leg01AnkleJnt_L"))

    # rleg
    config.TargetChains.append(
        ir.SoulIKRigChain("rleg1", "Rol01_Leg01Up01Jnt_R",
                          "Rol01_Leg01Up01Jnt_R"))
    config.TargetChains.append(
        ir.SoulIKRigChain("rleg2", "Rol01_Leg01Low01Jnt_R",
                          "Rol01_Leg01Low01Jnt_R"))
    config.TargetChains.append(
        ir.SoulIKRigChain("rleg3", "Rol01_Leg01AnkleJnt_R",
                          "Rol01_Leg01AnkleJnt_R"))

    # larm
    config.TargetChains.append(
        ir.SoulIKRigChain("larm0", "Rol01_Arm01ClavicleStartJnt_L",
                          "Rol01_Arm01ClavicleStartJnt_L"))
    config.TargetChains.append(
        ir.SoulIKRigChain("larm1", "Rol01_Arm01Up01Jnt_L",
                          "Rol01_Arm01Up01Jnt_L"))
    config.TargetChains.append(
        ir.SoulIKRigChain("larm2", "Rol01_Arm01Low01Jnt_L",
                          "Rol01_Arm01Low01Jnt_L"))
    config.TargetChains.append(
        ir.SoulIKRigChain("larm3", "Rol01_Hand01MasterJnt_L",
                          "Rol01_Hand01MasterJnt_L"))

    # rarm
    config.TargetChains.append(
        ir.SoulIKRigChain("rram0", "Rol01_Arm01ClavicleStartJnt_R",
                          "Rol01_Arm01ClavicleStartJnt_R"))
    config.TargetChains.append(
        ir.SoulIKRigChain("rram1", "Rol01_Arm01Up01Jnt_R",
                          "Rol01_Arm01Up01Jnt_R"))
    config.TargetChains.append(
        ir.SoulIKRigChain("rram2", "Rol01_Arm01Low01Jnt_R",
                          "Rol01_Arm01Low01Jnt_R"))
    config.TargetChains.append(
        ir.SoulIKRigChain("rram3", "Rol01_Hand01MasterJnt_R",
                          "Rol01_Hand01MasterJnt_R"))
    ...
    config.ChainMapping.append(
        ir.SoulIKRigChainMapping(True, False, "larm1", "larm1"))
    config.ChainMapping.append(
        ir.SoulIKRigChainMapping(True, False, "larm2", "larm2"))
    config.ChainMapping.append(
        ir.SoulIKRigChainMapping(True, False, "larm3", "larm3"))
...
if __name__ == "__main__":
    ...
    srcAnimationFile = to_model_path("Robot Hip Hop Dance.fbx")
    srcTPoseFile = to_model_path("Y_Bot.fbx")
